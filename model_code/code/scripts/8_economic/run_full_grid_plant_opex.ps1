...
$stdoutPath = Join-Path $logDir "scan_full_grid_plant_opex.stdout.log"
$stderrPath = Join-Path $logDir "scan_full_grid_plant_opex.stderr.log"
$exitCodePath = Join-Path $logDir "scan_full_grid_plant_opex.exit_code.txt"
$pidPath = Join-Path $logDir "scan_full_grid_plant_opex.pid.txt"
